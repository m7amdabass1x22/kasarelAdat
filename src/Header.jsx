...
export default function Header() {
  return (
    <>
      <header className="w-full h-25 bg-[#0F172A] border-b-4 border-gray-700 flex justify-center ">
        <div className="container flex justify-between items-center">
          ...
          <div className="hidden md:flex text-amber-50 gap-10 text-2xl font-bold ">
